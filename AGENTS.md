...
- Use the original Chocopuni product photos for proportions, fabric construction,
  face embroidery, and clothing. Inspect the existing model and its renders before
  extending the set.
- Before modelling a Blue Archive student's back, obtain and inspect reference
  images showing the student's rear or side, including hair, halo, and accessories.
  Prefer plush rear/overhead photos for sewn construction; supplement missing views
